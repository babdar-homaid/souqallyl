...
<?php } ?>
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="dad">
      <form class="" action="Search_daste.php" method="post">


          <div class="row">
              <div class="col-sm-6">
                  <label for="date"> من تاريخ:</label>
                  <input class="form-control" name="date2" required>
              </div>
              <div class="col-sm-6">
                      <label for="date">إلى تاريخ:</label>
                  <input class="form-control" name="date1" required>
                  </div>
...
<br>
  ...
  <tbody>
    ...
    <?php
     ...
     $query = "SELECT * FROM `data`WHERE  date between '$date2' AND '$date2' ";
