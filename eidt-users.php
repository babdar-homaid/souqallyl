    ...
    <div class="dad">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control input" name="name" value="<?= $row[1] ?>"  placeholder="تعديل الاسم  ">
        </div>
        <div class="form-group">
          <label >تعديل كلمة المرور</label>
          <input type="text" class="form-control input" name="pass" value="<?= $row[2] ?>"  placeholder="تعديل كلمة المرور  ">
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-12">
            <select class="form-control input" name="validity" required>
              ...
              <option <?php if($row[3] == 1){?>selected <?php } ?> value="1">ادمن</option>
              <option <?php if($row[3] == 2){?>selected <?php } ?> value="2">محرر</option>
              <option <?php if($row[3] == 3){?>selected <?php } ?> value="3">مستعرض</option>
            </select>

          </div>
        </div>
        <div class="form-group center" >
          <button type="submit" name="btnAdd" class="btn btn-outline-success " >تعديل </button>
