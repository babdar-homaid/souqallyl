...
<?php
  ...
  if(isset($_POST['btnAdd'])){
     $name = $_POST['name'];
         ...
         $sql = "UPDATE `type` SET `name` = '$name' WHERE `type`.`id` = $id";
         $rs = $db->dbQuery($sql);
         $err = "تم التعديل بنجاح";

         echo "<meta http-equiv='refresh' content='3;URL=type.php'>";
    ...
    <div class="dad">
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control input" name="name" value="<?= $row1[1] ?>"  placeholder="تعديل الحالة  ">
        </div>
