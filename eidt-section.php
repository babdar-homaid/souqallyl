...
<?php
  ...
  if(isset($_POST['btnAdd'])){
     $name = $_POST['name'];
         ...
         $sql = "UPDATE `section` SET `name` = '$name' WHERE `section`.`id` = $id";
         $rs = $db->dbQuery($sql);
         $err = "تم التعديل بنجاح";

         echo "<meta http-equiv='refresh' content='3;URL=section.php'>";
    ...
    <div class="dad">
      ...
      <form method="post">
        <div class="form-group">
          <label >تعديل القسم</label>
          <input type="text" class="form-control input" name="name" value="<?= $row[1] ?>"  placeholder="تعديل القسم  ">
        </div>
