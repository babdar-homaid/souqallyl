...
<?php
  ...
  if(isset($_POST['btnAdd'])){
     $name = $_POST['name'];
         ...
         $sql = "INSERT INTO `assignee` (`id`, `name`) VALUES (NULL, '$name')";
         $rs = $db->dbQuery($sql);
    ...
    <div class="dad">
      ...
      <form method="post">
        <div class="form-group">
          <label >اسم الجهة الجديدة</label>
          <input type="text" class="form-control input" name="name"  placeholder="اسم الجهة الجديدة">
        </div>
        <div class="form-group center" >
          <button type="submit" name="btnAdd" class="btn btn-outline-success " >اضافة </button>
