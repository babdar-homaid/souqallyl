  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          ...
          <a href="eidt-assignee.php?&id=<?= $row[0] ?>"><i class="fa fa-pencil-square-o"></i></a>|
          <a href="delete-assignee.php?id=<?= $row[0] ?>" onclick="return confirm('هل انت متأكد !!');"><i class="fa fa-trash-o"></i></a>
      </td>
    </tr>
  <?php } } ?>
...
<div class="form-group center" >
  <a href="add-assignee.php" class="btn btn-outline-success " >اضافة جديد</a>
